...
private:
  ...
  // Assume there is an external trigger that triggers cams
  // BUT does not send trigger messages
  // Essentially this just rounds the timestamp of the cam the the nearest
  // EXTERNAL_TRIGGER_FREQ e.g.: timestamp: 1.26, EXTERNAL_TRIGGER_FREQ = 10, ->
  // timestamp = 1.20
  bool USE_EXTERNAL_TRIGGER_TIME_SYNC;
  float EXTERNAL_TRIGGER_FREQ;
  ...
  dynamic_reconfigure::Server<spinnaker_sdk_camera_driver::spinnaker_camConfig>
      *dynamicReCfgServer_;
